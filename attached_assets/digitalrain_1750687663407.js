...
(function () {
  ...
  $packages["main"] = (function () {
    ...
    main = function () {
      ...
      $global.document.title = $externalize("BeingFi", $String);
        ...
        var _r, _r$1, _tuple, _tuple$1, cover, err, rain1, rain2, $s, $r;
          ...
          switch ($s) {
			...
			/* } */ case 2:
              ...
              cover.style.background = $externalize("linear-gradient(rgba(17,18,28,0), #11121C)", $String);
              ...
              cover.style.opacity = $externalize("0.9", $String);
    ...
    DigitalRain.ptr.prototype.layout = function () {
      ...
      r.canvas.style.height = $externalize('100vh', $String);
      r.canvas.style.position = $externalize("absolute", $String);
      r.canvas.style.top = $externalize("0", $String);
...
const timer = setInterval(() => {
  ...
  if (bodyDom.lastElementChild.tagName === 'canvas' || bodyDom.lastElementChild.tagName === 'CANVAS') {
    bodyDom.removeChild(bodyDom.lastElementChild);
    clearInterval(timer)
  }
}, 300)
