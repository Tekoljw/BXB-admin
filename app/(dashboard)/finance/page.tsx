...
export default function FinancePage() {
  ...
  return (
    <div className={`min-h-screen p-4 ${isDark ? "bg-background" : "bg-[#f5f8fa]"}`}>
      {/* Tabs - matching trading page style */}
      ...
      {/* New User Exclusive Banner - matching card style */}
      <div className="mb-6">
        <div className={`${cardStyle} rounded-lg p-6 relative overflow-hidden`}>
          {/* Background pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-4 right-8 w-12 h-12 rounded-full border-2 border-emerald-500"></div>
            <div className="absolute bottom-4 right-12 w-8 h-8 border border-emerald-500 rotate-45"></div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <div className="mb-3">
              <div className="flex items-baseline space-x-3">
                ...
                <span className="text-emerald-500 text-3xl font-bold">0.4%</span>
      ...
      {/* Products Grid - matching card style */}
