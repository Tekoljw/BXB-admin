              ...
              <div className="flex-1 grid grid-cols-2 gap-x-6 gap-y-3">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-medium text-sm truncate">{userInfo.email}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <Badge className="mt-0.5 text-xs">{userInfo.role}</Badge>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-medium text-xs truncate">{userInfo.lastLogin}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2 col-span-2">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs text-muted-foreground">登录位置</p>
                    <p className="font-medium text-xs truncate">{userInfo.lastLoginLocation}</p>
                  </div>
                </div>
              </div>
            </div>
