    ...
    <OrdersLayout>
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">手动开分</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <FileEdit className="w-8 h-8 text-custom-green" />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">3,500 USDT</h3>
              </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-700/50">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">用户ID</th>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {filteredRecords.map((record) => (
                  <tr key={record.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">{record.userId}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">{record.userName}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        record.type === '充值' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>新增手动开分</DialogTitle>
            <DialogDescription>
              为用户手动增加或扣减资金
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="credit">充值</SelectItem>
            ...
            <div className="grid gap-2">
              ...
              <Input id="amount" type="number" placeholder="请输入金额" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="reason">原因</Label>
              <Input id="reason" placeholder="请输入开分原因" />
            </div>
          </div>
          <DialogFooter>
