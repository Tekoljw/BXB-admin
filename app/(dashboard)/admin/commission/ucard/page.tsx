...
import { Users, TrendingUp, TrendingDown, CreditCard, Trophy, ArrowUpRight, ArrowDownRight, ChevronDown } from "lucide-react"
...
const mockPromoters: Promoter[] = Array.from({ length: 50 }, (_, i) => ({
  ...
  totalCommission: Math.floor(Math.random() * 500000) + 5000,
  totalVolume: Math.floor(Math.random() * 5000000) + 50000,
  referralCount: Math.floor(Math.random() * 300) + 5,
  todayCommission: Math.floor(Math.random() * 3000) + 50,
  yesterdayCommission: Math.floor(Math.random() * 3000) + 50,
  monthCommission: Math.floor(Math.random() * 30000) + 500,
  rank: i + 1,
