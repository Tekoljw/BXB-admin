...
export default function ChatPage() {
  ...
  const [activeTab, setActiveTab] = useState("担保")
  const [selectedContact, setSelectedContact] = useState<string | null>("escrow-group-1")
      ...
      { 
        ...
        guaranteeData: {
          ...
          steps: [
            ...
            { id: "step2", title: "双方签名确定合同以及确定付款时间", status: "pending" },
            { id: "step3", title: "等待甲方付款到担保账户", status: "pending" },
            { id: "step4", title: "等待乙方交付", status: "pending" },
            { id: "step5", title: "等待甲方确认付款", status: "pending" },
            { id: "step6", title: "交易完成", status: "pending" }
          ]
        }
      }
    ],
    "escrow-group-2": [
      { 
        ...
        guaranteeData: {
          ...
          expiresAt: "2024-02-01T14:45:00Z",
          steps: [
            { 
              id: "step1", 
              title: "AI助手起草合同", 
    ...
    "escrow-group-3": [
      { 
        ...
        guaranteeData: {
          amount: "12,000",
          currency: "USDT",
          description: "购买显卡RTX 4090",
          type: "buy",
          duration: "72小时",
          deposit: "20%",
          status: "accepted",
          createdAt: "2024-01-30T13:20:00Z",
          expiresAt: "2024-02-02T13:20:00Z",
          steps: [
            { 
              id: "step1", 
              title: "AI助手起草合同", 
    ...
    "escrow-group-4": [
      { 
        ...
        guaranteeData: {
          amount: "3,500",
          currency: "USDT",
          description: "购买iPad Pro",
          type: "buy",
          duration: "24小时",
          deposit: "10%",
          status: "accepted",
          createdAt: "2024-01-30T12:10:00Z",
          expiresAt: "2024-01-31T12:10:00Z",
          steps: [
            { 
              id: "step1", 
              title: "AI助手起草合同", 
            ...
            { 
              ...
              timestamp: "12:25",
              actions: [
                { label: "确认收货", type: "primary" },
                { label: "联系卖家", type: "secondary" }
              ]
            },
            { id: "step5", title: "等待甲方确认付款", status: "pending" },
            { id: "step6", title: "交易完成", status: "pending" }
    ...
    "escrow-group-5": [
      { 
        ...
        guaranteeData: {
          ...
          expiresAt: "2024-02-03T11:30:00Z",
          steps: [
            { 
              id: "step1", 
              title: "AI助手起草合同", 
            ...
            { 
              ...
              timestamp: "11:50",
              actions: [
                { label: "确认付款", type: "success" },
                { label: "申请退款", type: "danger" }
              ]
            },
            { id: "step6", title: "交易完成", status: "pending" }
          ]
    ...
    "escrow-group-7": [
      { 
        ...
        guaranteeData: {
          amount: "10,000",
          currency: "USDT",
          description: "购买游戏机PS5",
          type: "buy",
          duration: "48小时",
          deposit: "15%",
          status: "completed",
          createdAt: "2024-01-30T09:15:00Z",
          expiresAt: "2024-01-31T09:15:00Z",
          steps: [
            { 
              id: "step1", 
              title: "AI助手起草合同", 
            ...
            { 
              ...
              timestamp: "09:40",
              actions: [
                { label: "评价交易", type: "success" },
                { label: "下载收据", type: "secondary" }
              ]
            }
          ]
        }
                              ...
                              <div className="space-y-4">
                                {escrowData.steps.map((step, index) => (
                                  <div key={step.id} className="relative">
                                    ...
                                    {step.status === 'dispute' && index < escrowData.steps.length - 1 && (
                                      <div className="absolute left-4 top-4 w-0.5 h-16 bg-red-500 z-5" />
                                    )}
