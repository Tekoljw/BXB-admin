...
- **功能优化**:
    ...
    - **法币用户管理**: 提供筛选、账户余额详情、密钥管理、域名审核及精细化费率配置，支持资金冻结/解冻功能。
    - **订单管理**: 涵盖代收、代付、兑换订单管理，支持信息查看、补发通知、冻结/退款。
    - **Crypto模块**: 包含经营报表、币种管理、地址管理、供应商接口、Crypto出入金订单、Crypto用户管理（支持多币种余额、利润分析、交易量分析、费率配置、API密钥审批、冻结/解冻资金）、OTC供应商、OTC订单等子模块，并新增冻解记录页面。
    - **权限管理模块**: 包含业务线、审核配置、人员管理、用户权限、系统管理、系统日志、手动开分、手动转账、大额提币审核等9个子页面。
    - **财务模块**: 包含财务经营报表、Crypto资产管理、法币资产管理、U卡资产管理。
    - **U卡管理**: 包含用户、供应商（重构页面布局，支持展开/折叠卡片列表、资金池显示、余额显眼展示）、基础配置（两级页签系统，卡片独立配置）、号段、开卡记录、U卡划转兑换、消费记录、实体卡寄送订单等功能。
    - **C2C模块**: 包含C2C管理、C2C订单、法币快捷配置、法币快捷订单、OTC配置、OTC订单等子页面。
    - **法币模块**: 包含经营报表、法币用户管理、币种管理（支持inline编辑排序）、供应商管理、接口管理、通道管理、代理商管理、代收订单、代付订单、兑换订单等子模块，并新增冻解记录页面。
    - **佣金模块**: 包含支付佣金和U卡佣金，采用推广员排行榜设计。
